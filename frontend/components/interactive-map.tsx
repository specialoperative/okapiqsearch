...
const InteractiveMap: React.FC<InteractiveMapProps> = ({ 
  ...
  if (mapError) {
    return (
      <div className="w-full h-96 bg-gradient-to-br from-red-50 to-red-100 rounded-xl shadow-2xl flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-red-700 mb-4">Interactive map is currently unavailable</p>
          <button
  ...
  // Calculate map center from business coordinates
  const centerLat = businessesWithCoords.reduce((sum, b) => sum + b.coordinates[0], 0) / businessesWithCoords.length;
  const centerLng = businessesWithCoords.reduce((sum, b) => sum + b.coordinates[1], 0) / businessesWithCoords.length;
